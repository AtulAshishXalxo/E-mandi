        ...
        <div id="content">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        <div class="item">
                            <img src="img/main1.jpg" alt="" class="img-responsive" width="1500cm" height="2000cm">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/main2.jpg" alt="" width="1500cm" height="3000cm">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/main3.jpg" alt=""  width="1500cm" height="1200cm">
                        </div>
