...
<!--
								<script>
                                var deadline = new Date("today date, 2019 15:37:25").getTime(); 
                                ...
                                document.getElementById("btn btn-primary").innerHTML = days + "d "  
                                    + hours + "h " + minutes + "m " + seconds + "s "; 
                                    if (t < 0) { 
                                        clearInterval(x); 
                                        document.getElementById("btn btn-primary").innerHTML = "EXPIRED"; 
                                    } 
                                }, 1000); 
                                </script>	
-->
                                ...
                                <p class="text-center buttons">
                                    <a href="" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Buy now for Rs    <?php echo number_format($row['ExpectedPrice'],2);?> 
                                    </a> 
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="product same-height">
                                ...
                                <a href="detail.php?ItemNo=<?php echo $row2['ItemID'] ?>" class="invisible">
                                    <img src="img/grass.jpg" alt="" class="img-responsive">
                                </a>
                                <div class="text">
