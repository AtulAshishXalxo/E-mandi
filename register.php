            ...
            <div class="container">
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <p>With registration with us, you can be a part of the Organic Product Auction site.</p>
                        ...
                        <form action="process_register.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="cno" name="cno" maxlength="10" min="10">
                            </div>
                            <div class="form-group">
