...
$sql="SELECT ItemID,ItemName,SellerID,StartingPrice,ExpectedPrice,CurrentPrice,PhotosID,Description,CategoryID,EndTime FROM item ORDER BY ItemID";
	...
	echo "
	<tr>
		<td>" . $row["ItemID"] . "</td><td>" . $row["ItemName"] . "</td><td>" . $row["SellerID"] . "</td><td>" . $row["StartingPrice"] . "</td><td>" . $row["ExpectedPrice"] . "</td><td>" . $row["CurrentPrice"] . "</td><td>" . $row["PhotosID"] . "</td><td>" . $row["Description"] . "</td><td>" . $row["CategoryID"] . "</td><td>" . $row["EndTime"] . "</td>
	</tr>";
	}
...
elseif (isset($_POST['btime' ])) {
	...
	echo '<div style="width:49%; float:left;"><h2>User Table</h2>';
	$sql = "SELECT UserID,Username,Password,Contact_No,Address,FName,LName FROM user ORDER BY UserID";
	$result = $conn -> query($sql);
	...
	echo "
	<tr>
		<td>" . $row["UserID"] . "</td><td>" . $row["Username"] . "</td><td>" . $row["Password"] . "</td><td>" . $row["Contact_No"] . "</td><td>" . $row["Address"] . "</td><td>" . $row["FName"] . "</td><td>" . $row["LName"] . "</td>
	</tr>";
	}
